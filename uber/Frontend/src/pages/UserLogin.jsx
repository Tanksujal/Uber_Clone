  ...
  return (
    <div className="p-7 h-screen flex flex-col justify-between">
      ...
      <p className="text-center">New here?<Link className="text-blue-600" to={'/signup'}>Create New Account</Link></p>
        ...
        <div>
        <Link to={'/captain-login'} className="bg-[#10b461] flex items-center justify-center mb-5 text-white font-semibold  rounded px-4 py-2  w-full text-lg placeholder:text-base mb-7 ">Sign in as Captain</Link>
        </div>
    </div>
  )
}
